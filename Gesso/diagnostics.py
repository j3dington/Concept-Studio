...
import psutil
import os
from draggable import DraggableFrame # Assuming this is your helper class

class DiagnosticsPanel(DraggableFrame): 
    visibility_changed = pyqtSignal(bool)# Inherit from Draggable
    def __init__(self, canvas_ref):
        ...
        self.btn_close.clicked.connect(self.hide) # Built-in Qt method to hide widget
    ...
    def refresh_diagnostics(self):
        ...
        self.lbl_undo.setText(f"STEPS: {len(self.canvas.undo_stack)}")